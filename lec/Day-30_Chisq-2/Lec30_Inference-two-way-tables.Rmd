---
title: 'Lecture 30: The Chi-Square Test for Two-Way Tables'
subtitle: 'Chapter 22'
...
```{r}
library(tibble)
two_way <- tribble(~ lungcancer, ~ non_lungcaner,
...
same.
- When you have data that looks like this, you may want to use a z-test because
...
```{r}
# make contigency table from data above, in this case I do
