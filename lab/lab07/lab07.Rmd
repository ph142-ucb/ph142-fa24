---
title: 'Lab 7: Normal, Binomial, and Poisson Distribution'
...
### Instructions
* Due date: Friday, October 18th at 10:00 pm PST with a 2 hour grace period.
...
cd; cd ph142-fa24/lab/lab07; python3 turn_in.py
...
ottr::export("lab06_current.Rmd", pdf = TRUE)
```
